...
test_that(desc = "Testing output column types", code = {
  expect_true(object = all(unlist(lapply(actual_1[,-"comparison"], function(x) is.numeric(x) | any(is.na(x))))))
  expect_true(object = all(unlist(lapply(actual_2[,-"comparison"], function(x) is.numeric(x) | any(is.na(x))))))
  expect_true(object = all(unlist(lapply(actual_3[,-"comparison"], function(x) is.numeric(x) | any(is.na(x))))))
  expect_true(object = all(unlist(lapply(actual_4[,-"comparison"], function(x) is.numeric(x) | any(is.na(x))))))
  expect_true(object = all(unlist(lapply(actual_5[,-"comparison"], function(x) is.numeric(x) | any(is.na(x))))))
  expect_type(object = actual_1$comparison, type = "character")
  expect_type(object = actual_2$comparison, type = "character")
  expect_type(object = actual_3$comparison, type = "character")
  expect_type(object = actual_4$comparison, type = "character")
